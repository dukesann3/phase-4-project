            ...
            <Form onSubmit={handleSubmit}>
                ...
                <Form.Group widths='equal'>
                    ...
                    <Form.Input fluid label='Sales Order' placeholder='Sales Order' name="sales_order" 
                            type='number' value={form.sales_order} onChange={handleChange}/>
                </Form.Group>
                <Form.Group widths='equal'>
                    ...
                    <Form.Input fluid label='Sale Price'placeholder='Sale Price' name='sale_price'
                            value={form.sale_price} type='number' onChange={handleChange}/>
                </Form.Group>
                <Form.Group widths='equal'>
                    <Form.Input fluid label='Start Date' name='start_date' value={form.start_date}
                            type='date' onChange={handleChange}/>

                    <Form.Input fluid label='Expected End Date' name='expected_end_date' value={form.expected_end_date}
                            type='date' onChange={handleChange}/>
                </Form.Group>
                <Form.Group widths='equal'>
                    <Form.TextArea fluid label="Comments" placeholder='comments'
